...
ALL_CFLAGS = -I$(LOCAL)/include -I$(EXTERNAL_ROOT)/android-system-core/include $(DEFINES)
MY_CFLAGS = $(ALL_CFLAGS) -Wall -O -Werror -Wextra -pedantic -std=c99
...
yaffsunlock.o: yaffsunlock.c
	$(CC) $(MY_CFLAGS) $(CFLAGS) -o "$*.o" -c "$*.c"
